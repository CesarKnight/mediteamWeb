...
<head>
    <meta charset="utf-8">
    <title>Historial de Pagos Paciente</title>
    <style>
        ...
        .sin-pagos { padding: 20px; text-align: center; color: #9ca3af; font-style: italic; }
...
<body>
    <div class="header">
        <h1>Historial de Pagos Paciente</h1>
    ...
    @if ($pagos->isEmpty())
        <div class="sin-pagos">
            No se encontraron pagos registrados para el paciente en el periodo seleccionado.
        </div>
    @else
        <table class="eventos">
            <thead>
