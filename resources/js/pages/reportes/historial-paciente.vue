...
import { CalendarClock, FileText, Stethoscope, Pill, ClipboardList, Download } from '@lucide/vue';
...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Historial de Paciente', href: '' },
        ],
    },
});
...
<template>
    <Head title="Historial de Paciente" />

    <div class="m-6 flex flex-col gap-6">
        <Heading
            title="Historial de Paciente"
            description="Genera un reporte en PDF con el historial clínico completo de un paciente."
        />
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Selecciona el paciente y, opcionalmente, un rango de fechas para acotar el historial.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form
                    v-bind="generarHistorialPaciente.form()"
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <Card>
                    <CardContent class="flex items-center gap-3 py-4">
                        ...
                        <div>
                            <p class="text-lg font-semibold leading-none">{{ resumen.totalDiagnosticos }}</p>
                            <p class="text-xs text-muted-foreground">Diagnósticos</p>
                        </div>
                    </CardContent>
                </Card>
                <Card>
            ...
            <Card>
                <CardHeader class="flex flex-row items-center justify-between">
                    ...
                    <Button as-child variant="outline" size="sm">
                        <a :href="pdfDataUrl" download="historial-paciente.pdf">
                ...
                <CardContent>
                    <iframe
                        ...
                        title="Vista previa del historial de paciente"
                    />
                </CardContent>
            </Card>
        </template>
