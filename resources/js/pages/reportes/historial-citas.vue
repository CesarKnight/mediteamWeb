...
import { FileText, CalendarClock, Users, ListChecks, Download } from '@lucide/vue';
...
<template>
    ...
    <div class="m-6 flex flex-col gap-6">
        <Heading
            ...
            description="Genera un reporte en PDF con las citas atendidas por un médico."
        />
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Selecciona el médico y, opcionalmente, un rango de fechas para acotar las citas.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form
                    v-bind="generarHistorialCitas.form()"
            ...
            <div class="grid grid-cols-3 gap-4">
                <Card>
                    <CardContent class="flex items-center gap-3 py-4">
                        ...
                        <div>
                            <p class="text-lg font-semibold leading-none">{{ resumen.totalCitas }}</p>
                            <p class="text-xs text-muted-foreground">Citas</p>
                        </div>
                    </CardContent>
                </Card>
                <Card>
                ...
                <Card>
                    <CardContent class="flex items-center gap-3 py-4">
                        ...
                        <div>
                            <p class="text-lg font-semibold leading-none">{{ resumen.serviciosUnicos }}</p>
                            <p class="text-xs text-muted-foreground">Servicios distintos</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card>
                <CardHeader class="flex flex-row items-center justify-between">
                    ...
                    <Button as-child variant="outline" size="sm">
                        <a :href="pdfDataUrl" download="historial-citas.pdf">
                ...
                <CardContent>
                    <iframe
                        ...
                        title="Vista previa del historial de citas"
                    />
                </CardContent>
            </Card>
        </template>
